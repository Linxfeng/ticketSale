		...
		<form class="form-inline">
			...
			<div class="form-group mar-left-10">
				<label for="">出发日期：</label> <input type="text" class="form-control"
					style="width: 110px;" id="startDay" value="2017-09-30" 
					onClick="WdatePicker()">
			</div>
			<div class="form-group mar-left-10">
				<label for="">车型：</label>
			...
			<div>
				...
				<ul class="list-inline bor-bottom-solid-1  ">
					<li class="w-percentage-20"><strong
								class="rmb orange-f60 font16">${train.tid}</strong></li>
					<li class="w-percentage-20  font16">${train.stationList[0].sname1}&nbsp;
						—&nbsp;${train.stationList[1].sname2}</li>
					<li class="w-percentage-25  font16">${train.stationList[0].stime1}&nbsp;
						—&nbsp;${train.stationList[1].stime2}</li>
					<li class="w-percentage-25">共 ${train.stacount} 站</li>
					<li><button type="button" class="btn btn-danger btn-sm" 
						onClick="toBuy('${train.tid}','${train.stationList[0].sname1}','${train.stationList[1].sname2}');">
						购票</button></li>
				</ul>
				<!-- 表头结束 -->
				<!-- 表BODY -->
				<div class="collapse " id="collapseExample2" style="display: block;">
					<div class="hangbanlist-body " style="background-color: #FEFCFC;">
						<ul class="list-inline">
							...
							<li class="w-percentage-20">${train.stype1}：${train.scount1}票</li>
							<li class="w-percentage-25">${train.stype2}：${train.scount2}票</li>
							<li class="w-percentage-25">${train.stype3}：${train.scount3}票</li>
							<li class="pull-right">&nbsp;</li>
						</ul>
						<ul class="list-inline">
							<li class="w-percentage-20">普通票价/<span
								class="rmb orange-f60">优惠价</span></li>
							<li class="w-percentage-20">￥${train.tmoney1} / <strong
								class="rmb orange-f60">￥${train.tmoney1 * 0.75}</strong></li>
							<li class="w-percentage-25">￥${train.tmoney2} / <strong
								class="rmb orange-f60">￥${train.tmoney2 * 0.75}</strong></li>
							<li class="w-percentage-25 ">￥${train.tmoney3} / <strong
								class="rmb orange-f60">￥${train.tmoney3 * 0.75}</strong></li>
							<li class="pull-right">&nbsp;</li>
						</ul>
					</div>
				</div>
