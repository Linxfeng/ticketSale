...
<div class="container bg-gray-eee box-shadow mar-bottom-30" 
  ...
  <div class="rightCon">
	...
	<!-- 订单信息 -->
	<form action="${pageContext.request.contextPath}/orderController/toPay.action" 
		method="post" name="sureorderForm" >
    <div class="text-center">
    	<a href='javascript:history.go(-1);'><input type="button" value="返回" class="btn btn-default">
    	</a><input type="submit" value="立即支付" class="btn btn-default" onClick="return confirm('是否确认付款？');">
   	</div>
   </form>
  </div>
</div>
