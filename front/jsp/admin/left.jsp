...
<dl class="leftmenu"
	...
	<dd>
		...
		<ul class="menuson">
			<li><cite></cite><a href="${pageContext.request.contextPath }/AdverController/toAdver.action"
								target="rightFrame">发放通知/公告</a><i></i></li>
			<li><cite></cite><a href="${pageContext.request.contextPath }/AdverController/findAllAdvert.action"
								target="rightFrame">广告管理</a><i></i></li>
		</ul>
	</dd>
</dl>
</body>
