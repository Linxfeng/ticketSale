...
<div id="page" class="clearfix">
    ...
    <div id="menu">
        <ul class="menubg">
            ...
            <li><a href="${pageContext.request.contextPath}/jsp/user/loginUi.jsp"
                   target="_blank">用户登录</a></li>
            <li><a href="${pageContext.request.contextPath}/jsp/user/register.jsp"
                   target="_blank">用户注册</a></li>
            <li><a href="${pageContext.request.contextPath}/jsp/admin/login.jsp"
